...
data = np.load("rwl_noisy_comparison.npz",allow_pickle = True)
# data = np.load("rwl_noisy_comparison_large_noise.npz",allow_pickle = True)
...
recovery_threshold = 5e-2
recovery_d = np.where(distance <= recovery_threshold,1,0)
print("r and rd",np.linalg.norm(recovery_d-recovery))
...
# fig0.savefig("rwl1_noisy_recovery.png",format ="png")
# fig0.savefig("rwl1_noisy_recovery.eps",format ="eps")
fig0.savefig("rwl1_noisy_recovery.pdf",format ="pdf")
...
# fig1.savefig("rwl1_noisy_wall.png",format ="png")
# fig1.savefig("rwl1_noisy_wall.eps",format ="eps")
fig1.savefig("rwl1_noisy_wall.pdf",format ="pdf")
...
# fig2.savefig("rwl1_noisy_iter_count.png",format ="png")
# fig2.savefig("rwl1_noisy_iter_count.eps",format ="eps")
fig2.savefig("rwl1_noisy_iter_count.pdf",format ="pdf")
...
# fig3.savefig("rwl1_noisy_wall_per_cg.png",format ="png")
# fig3.savefig("rwl1_noisy_wall_per_cg.eps",format ="eps")
fig3.savefig("rwl1_noisy_wall_per_cg.pdf",format ="pdf")